...
- Related contribution: [Draft PR #216](https://github.com/Tencent/YOLO-Master/pull/216).
...
PR #216 was Open and Draft at that snapshot. No document in this repository should be read as a claim of merge,
acceptance, official endorsement, or ownership of the upstream framework.
